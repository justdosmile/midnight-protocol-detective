...
- тихая музыка с дождём, которая создаётся прямо в браузере;
...
Музыка, дождь и короткие сигналы создаются Web Audio API. Они включаются после действия игрока, поэтому браузер не блокирует звук. Игра остаётся полностью проходимой с выключенной музыкой.
